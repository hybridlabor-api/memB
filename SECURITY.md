...
We take the security of MemB and our community seriously. Thank you for helping
keep MemB and its users safe by disclosing vulnerabilities responsibly.
...
If you believe you have found a security vulnerability in MemB, please report it
privately through one of the following channels:

1. **GitHub Private Vulnerability Reporting** — open a
   [private security advisory](https://github.com/membai/memb/security/advisories/new)
   directly on this repository.
2. **Email** the maintainers at **support@memb.ai** with the subject line:

   `SECURITY: MemB vulnerability report`
