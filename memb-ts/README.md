# MemB - The Memory Layer for Your AI Apps

MemB is a self-improving memory layer for LLM applications, enabling personalized AI experiences that save costs and delight users. We offer both cloud and open-source solutions to cater to different needs.

See the complete [OSS Docs](https://docs.memb.ai/open-source/node-quickstart).
See the complete [Platform API Reference](https://docs.memb.ai/api-reference).

## 1. Installation

For the open-source version, you can install the MemB package using npm:
...
For the cloud offering, sign in to [MemB Platform](https://app.memb.ai/dashboard/api-keys?utm_source=oss&utm_medium=memb-ts-readme) to obtain your API Key.
...
MemB provides a simple and customizable interface for performing memory operations. You can create long-term and short-term memories, search for relevant memories, and manage memory history.
...
- Email: founders@memb.ai
- [Join our discord community](https://memb.ai/discord)
- GitHub Issues: [Report bugs or request features](https://github.com/membai/memb/issues)
