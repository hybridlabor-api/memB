/**
 * Structured exception classes for memb TypeScript SDK.
 *
 ...
 * @example
 * ```typescript
 * import { RateLimitError, MemoryNotFoundError } from 'membai'
 *
 * try {
 ...
 *
 * Every memb exception includes an error code for programmatic handling,
