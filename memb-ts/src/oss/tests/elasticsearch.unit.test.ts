...
describe("ElasticsearchDB", () => {
  ...
  describe("insert", () => {
    it("bulk indexes vectors with ids and payloads", async () => {
      ...
      expect(mockBulk).toHaveBeenCalledWith({
        operations: [
          { index: { _index: "memb", _id: "id-1" } },
          { vector: [0.1, 0.2, 0.3, 0.4], metadata: { user_id: "u1" } },
          { index: { _index: "memb", _id: "id-2" } },
  ...
  describe("get", () => {
    it("returns document by id", async () => {
      ...
      expect(mockGet).toHaveBeenCalledWith({ index: "memb", id: "id-1" });
  ...
  describe("delete", () => {
    it("deletes document by id", async () => {
      ...
      expect(mockDelete).toHaveBeenCalledWith({ index: "memb", id: "id-1" });
    });
  });
  ...
  describe("deleteCol", () => {
    it("deletes the index", async () => {
      ...
      expect(mockIndicesDelete).toHaveBeenCalledWith({ index: "memb" });
    });
  });
