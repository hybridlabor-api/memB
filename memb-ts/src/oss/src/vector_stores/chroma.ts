 ...
 *
 * Mirrors the Python SDK's `memb.vector_stores.chroma.ChromaDB` behavior using
 * the `chromadb` v3 JavaScript client. Embeddings are always supplied by memb,
...
export class ChromaDB implements VectorStore {
  ...
  /**
   * Generate a properly formatted `where` clause for ChromaDB from memb's
