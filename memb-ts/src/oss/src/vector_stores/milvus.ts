 ...
 * (`memb/configs/vector_stores/milvus.py`).
 */
...
export interface MilvusConfig extends VectorStoreConfig {
  ...
  dbName?: string;
  /** Collection name. Defaults to `memb`. */
 ...
 *
 * Mirrors the Python provider in `memb/vector_stores/milvus.py`: dense-vector
...
export class Milvus implements VectorStore {
  ...
  constructor(config: MilvusConfig) {
    this.collectionName = config.collectionName || "memb";
