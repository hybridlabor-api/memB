"""Structured exception classes for MemB with error codes, suggestions, and debug information.
...
and recovery in applications using MemB.
...
class MemoryError(Exception):
    ...
    This is the base class for all MemB-specific exceptions. It provides a structured
...
class AuthenticationError(MemoryError):
    ...
    Example:
        raise AuthenticationError(
            ...
            error_code="AUTH_001",
            suggestion="Please check your API key in the MemB dashboard"
        )
    """
    pass
...
class NetworkError(MemoryError):
    ...
    Example:
        raise NetworkError(
            ...
            debug_info={"timeout": 30, "endpoint": "api.memb.ai"}
        )
    """
    pass
