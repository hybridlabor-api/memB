...
from memb.memory.utils import extract_json
...
class AzureAISearch(VectorStoreBase):
    def __init__(
        ...
        self.search_client._client._config.user_agent_policy.add_user_agent("memb")
        self.index_client._client._config.user_agent_policy.add_user_agent("memb")
