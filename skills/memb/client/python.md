# MemB Python SDK Reference

Complete reference for the `membai` Python package. Covers both the Platform client (managed API) and the Open Source self-hosted variant.
...
**Import:** `from memb import Memory` (NOT `MemoryClient` -- that is the Platform client)
...
See the [v2 to v3 migration guide](https://docs.memb.ai/migration/oss-v2-to-v3) for full details.
