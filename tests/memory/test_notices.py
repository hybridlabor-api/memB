...
from memb.memory import main as memory_main
from memb.memory import notices
from memb.memory import telemetry as telemetry_module
...
def test_displayed_notice_logs_once_and_captures_event(notice_harness, capsys):
    ...
    assert capsys.readouterr().err == "MemB OSS notice\n"
    ...
    assert props["payload"] == "MemB OSS notice"
