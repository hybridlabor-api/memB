...
from memb.llms.aws_bedrock import AWSBedrockLLM, extract_provider
from memb.utils.factory import LlmFactory
...
def mock_boto3():
    ...
    with patch("memb.llms.aws_bedrock.boto3") as mock_b3:
