...
from memb.llms.azure_openai_structured import SCOPE, AzureOpenAIStructuredLLM
...
@mock.patch("memb.llms.azure_openai_structured.AzureOpenAI")
...
@mock.patch("memb.llms.azure_openai_structured.AzureOpenAI")
@mock.patch("memb.llms.azure_openai_structured.get_bearer_token_provider")
@mock.patch("memb.llms.azure_openai_structured.DefaultAzureCredential")
...
def test_init_with_env_vars(monkeypatch, mocker):
    mock_azure_openai = mocker.patch("memb.llms.azure_openai_structured.AzureOpenAI")
...
def test_init_with_placeholder_api_key_uses_default_credential(
    ...
    with (
        mock.patch("memb.llms.azure_openai_structured.DefaultAzureCredential") as mock_credential,
        mock.patch("memb.llms.azure_openai_structured.get_bearer_token_provider") as mock_token_provider,
    ):
