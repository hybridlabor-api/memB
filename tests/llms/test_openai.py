...
from memb.llms.openai import OpenAILLM
...
def test_gpt5_mini_not_classified_as_reasoning(mock_openai_client):
    ...
    Regression test for https://github.com/membai/memb/issues/4738
    """
...
def test_is_reasoning_model_explicit_override(mock_openai_client):
    ...
    See https://github.com/membai/memb/issues/5296 — deployments with custom or
...
def test_gpt5_uses_max_completion_tokens(mock_openai_client):
    ...
    https://github.com/membai/memb/issues/5054
    """
