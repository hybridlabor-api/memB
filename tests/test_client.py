...
def mock_memory_client():
    ...
    with patch("memb.client.main.httpx.Client") as mock_httpx:
        ...
        with patch("memb.client.main.capture_client_event"):
            from memb.client.main import MemoryClient
...
class TestPathSegmentEncoding:
    ...
    async def _assert_async_memory_id_path_segments_are_encoded(self):
        from memb.client.main import AsyncMemoryClient
...
class TestValidateApiKeyHttpError:
    ...
    def test_sync_client_non_json_5xx_raises_clear_error(self):
        ...
        request = httpx.Request("GET", "https://api.memb.ai/v1/ping/")
    ...
    def test_async_client_non_json_5xx_raises_clear_error(self):
        ...
        with patch("memb.client.main.requests.get", return_value=response):
            with patch("memb.client.main.capture_client_event"):
                from memb.client.main import AsyncMemoryClient
