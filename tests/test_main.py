...
from memb.memory.main import Memory, _validate_and_trim_entity_id
...
def test_search(memory_instance):
    ...
    with patch("memb.memory.main.lemmatize_for_bm25", return_value="test query"), \
...
class TestSearchParamValidation:
    ...
    def test_search_trims_query_before_embedding(self, memory_instance):
        ...
        with patch("memb.memory.main.lemmatize_for_bm25", return_value="test"), \
             patch("memb.memory.main.extract_entities", return_value=[]):
