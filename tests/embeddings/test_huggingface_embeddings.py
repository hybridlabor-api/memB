...
from memb.embeddings.huggingface import HuggingFaceEmbedding


@pytest.fixture
def mock_sentence_transformer():
    with patch("memb.embeddings.huggingface.SentenceTransformer") as mock_transformer:
        mock_model = Mock()
...
def test_embed_with_huggingface_base_url():
    ...
    with patch("memb.embeddings.huggingface.OpenAI") as mock_openai:
        mock_client = Mock()
