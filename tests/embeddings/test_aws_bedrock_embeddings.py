...
from memb.embeddings.aws_bedrock import AWSBedrockEmbedding


@pytest.fixture
def mock_boto3_client():
    with patch("memb.embeddings.aws_bedrock.boto3.client") as mock_client:
...
def test_session_token_from_config_is_passed_to_client(mock_boto3_client):
    ...
    """
    with patch("memb.embeddings.aws_bedrock.os.environ", {}):
...
def test_session_token_falls_back_to_env(mock_boto3_client):
    ...
    with patch.dict(
        "memb.embeddings.aws_bedrock.os.environ",
