...
Refs: https://github.com/membai/memb/issues/4453
"""
...
def _run_threshold_test(store, query, doc_vectors, payloads, ids):
    ...
    # The check in memb/memory/main.py is: if threshold is None or mem.score >= threshold
...
class TestChromaDBThreshold:
    def test_threshold_filtering(self, tmp_path):
        from memb.vector_stores.chroma import ChromaDB
...
class TestFAISSEuclideanThreshold:
    def test_threshold_filtering(self, tmp_path):
        from memb.vector_stores.faiss import FAISS
...
PGVECTOR_USER = os.environ.get("PGVECTOR_USER", "memb")
PGVECTOR_PASS = os.environ.get("PGVECTOR_PASSWORD", "membtest")
PGVECTOR_DB = os.environ.get("PGVECTOR_DB", "memb_test")
...
class TestPGVectorThreshold:
    def test_threshold_filtering(self):
        from memb.vector_stores.pgvector import PGVector
        ...
        store = PGVector(
            ...
            host=PGVECTOR_HOST,
            port=PGVECTOR_PORT,
            user=os.environ.get("PGVECTOR_USER", "memb"),
            password=os.environ.get("PGVECTOR_PASSWORD", "membtest"),
            dbname=os.environ.get("PGVECTOR_DB", "memb_test"),
            diskann=False,
            hnsw=True,
        )
        query, doc_vectors = _make_vectors()
...
class TestRedisThreshold:
    def test_threshold_filtering(self):
        ...
        from memb.vector_stores.redis import RedisDB
...
class TestValkeyThreshold:
    def test_threshold_filtering(self):
        ...
        from memb.vector_stores.valkey import ValkeyDB
...
class TestMilvusL2Threshold:
    def test_threshold_filtering(self):
        from memb.vector_stores.milvus import MilvusDB
...
class TestSupabaseThreshold:
    def test_threshold_filtering(self):
        from memb.vector_stores.supabase import Supabase
...
class TestS3VectorsThreshold:
    def test_threshold_filtering(self):
        from memb.vector_stores.s3_vectors import S3Vectors
