...
from memb.vector_stores.databricks import Databricks
...
def mock_workspace_client():
    ...
    with patch("memb.vector_stores.databricks.WorkspaceClient") as mock_wc_cls:
        ...
        mock_wc.vector_search_indexes.create_index.return_value = SimpleNamespace(name="catalog.schema.memb")
        ...
        mock_wc.vector_search_indexes.get_index.return_value = SimpleNamespace(name="memb")
...
def test_config_rejects_old_doc_params():
    ...
    from memb.configs.vector_stores.databricks import DatabricksConfig
...
def test_e2e_config_to_factory_delta_sync(mock_workspace_client):
    ...
    from memb.utils.factory import VectorStoreFactory
    from memb.vector_stores.configs import VectorStoreConfig
...
class TestIdentifierValidation:
    ...
    def test_accepts_valid_identifiers(self, mock_workspace_client):
        ...
        assert db.fully_qualified_index_name == "my_catalog.my_schema.memb"
