...
def test_insert(valkey_db, mock_valkey_client):
    ...
    assert args[0] == "memb:test_collection:test_id"
...
def test_delete(valkey_db, mock_valkey_client):
    ...
    mock_valkey_client.delete.assert_called_once_with("memb:test_collection:test_id")
...
def test_get(valkey_db, mock_valkey_client):
    ...
    mock_valkey_client.hgetall.assert_called_once_with("memb:test_collection:test_id")
...
def test_cluster_mode_delete(valkey_db_cluster, mock_valkey_cluster_client):
    ...
    mock_valkey_cluster_client.delete.assert_called_once_with("memb:test_cluster:id1")
...
def test_default_fields_memory_is_text():
    ...
    inverted index.
    """
    from memb.vector_stores.valkey import DEFAULT_FIELDS
