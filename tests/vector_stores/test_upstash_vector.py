...
from memb.configs.vector_stores.upstash_vector import UpstashVectorConfig
from memb.vector_stores.upstash_vector import UpstashVector
...
def test_env_var_only_config_builds_provider(monkeypatch):
    ...
    dumped = UpstashVectorConfig(collection_name="memb").model_dump()
    ...
    with patch("memb.vector_stores.upstash_vector.Index") as mock_index:
