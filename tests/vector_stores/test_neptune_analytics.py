...
from memb.configs.vector_stores.neptune import NeptuneAnalyticsConfig
from memb.utils.factory import VectorStoreFactory
from memb.vector_stores.neptune_analytics import (
...
# Configure logging
logging.getLogger("memb.vector.neptune.main").setLevel(logging.INFO)
logging.getLogger("memb.vector.neptune.base").setLevel(logging.INFO)
...
class TestNeptuneAnalyticsVectorInitValidation:
    def test_accepts_valid_identifier(self, monkeypatch):
        from memb.vector_stores.neptune_analytics import NeptuneAnalyticsVector
        monkeypatch.setattr("memb.vector_stores.neptune_analytics.NeptuneAnalyticsGraph", lambda *args, **kwargs: None)
