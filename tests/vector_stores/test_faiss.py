...
from memb.vector_stores.faiss import (
    FAISS,
    OutputData,
    SafeUnpickler,
    _safe_pickle_load,
...
class TestFAISSSecurityIntegration:
    ...
    def test_faiss_saves_as_json(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("memb.vector_stores.faiss.faiss.IndexFlatL2", return_value=mock_index):
                with patch("memb.vector_stores.faiss.faiss.write_index"):
                    faiss_store = FAISS(
    ...
    def test_faiss_loads_json_preferentially(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch("memb.vector_stores.faiss.faiss.read_index", return_value=mock_index):
                with patch("memb.vector_stores.faiss.faiss.write_index"):
