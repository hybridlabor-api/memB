...
class TestExtractEntities:
    def test_proper_nouns(self):
        from memb.utils.entity_extraction import extract_entities
    ...
    def test_handles_names_lists_and_identifiers(self):
        ...
        text = (
            ...
            "The email field for MemB lives at person.properties.email. "
        ...
        assert {"OpenClaw", "Claude Code", "Codex", "Dify", "Cartesia", "Deepgram", "MemB"}.issubset(entity_texts)
...
class TestExtractEntitiesBatch:
    def test_batch_processing(self):
        from memb.utils.entity_extraction import extract_entities_batch
