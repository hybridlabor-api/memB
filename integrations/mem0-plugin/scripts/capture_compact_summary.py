#!/usr/bin/env python3
"""Capture the post-compaction summary into memb.
...
log = logging.getLogger("memb-compact-summary")
log.setLevel(logging.DEBUG)
_handler = logging.StreamHandler(sys.stderr)
_handler.setFormatter(logging.Formatter("[memb-compact-summary] %(message)s"))
...
if os.environ.get("MEMB_DEBUG"):
    ...
    try:
        ...
        _file_handler.setFormatter(logging.Formatter("[memb-compact-summary] %(asctime)s %(message)s"))
...
def main():
    ...
    marker_dir = os.path.expanduser("~/.memb")
