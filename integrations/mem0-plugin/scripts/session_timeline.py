...
Searches memb cloud API for the most recent memories in the project
...
def format_timeline(memories: list[dict]) -> str:
    ...
    for m in memories:
        ...
        lines.append(f"- {icon} [{cat}]{age_str} {text} [memb:{mid}]")

    lines.append("")
    lines.append("Search memb for details on any of these, or for past decisions and task learnings relevant to the current task.")
