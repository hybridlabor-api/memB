#!/usr/bin/env python3
"""Import memories from competing AI tool configuration files into memb.
...
splits them into chunks, and POSTs each chunk to the memb API as a
...
HASH_STORE = os.path.expanduser("~/.memb/import_hashes.json")
...
def post_memory(api_key: str, content: str, user_id: str, project_id: str, branch: str, source: str) -> bool:
    """POST a single memory chunk to the memb API."""
    metadata: dict = {
