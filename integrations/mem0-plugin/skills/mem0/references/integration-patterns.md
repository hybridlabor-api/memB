...
def retrieve_context(query: str, user_id: str):
    ...
    memories = memb.search(query, filters={"user_id": user_id})
...
> **Dedicated skill available.** For comprehensive Vercel AI SDK documentation, see the [memb-vercel-ai-sdk skill](https://github.com/membai/memb/tree/main/skills/memb-vercel-ai-sdk).
...
def search_memory(query: str, user_id: str) -> str:
    ...
    memories = memb.search(query, filters={"user_id": user_id}, top_k=3)
...
def chatbot(state: State):
    ...
    memories = memb.search(messages[-1].content, filters={"user_id": user_id})
