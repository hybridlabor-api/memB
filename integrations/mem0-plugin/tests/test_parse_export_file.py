"""Tests for parse_export_file.py — memb export file parser."""
...
def test_main_cli_outputs_json(tmp_path):
    ...
    export_file = tmp_path / "memb-export-test.md"
