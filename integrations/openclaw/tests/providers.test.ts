 ...
 * underlying MemBProvider methods with proper argument mapping.
 */
...
describe("customCategoryMapToList", () => {
  it("converts category maps to the MemB SDK list shape", () => {
    expect(
      customCategoryMapToList({
...
describe("PlatformProvider", () => {
  it("passes custom_categories as a list to the MemB SDK", async () => {
