"""
Personal Voice Assistant with Memory (Whisper + CrewAI + MemB + ElevenLabs)
...
- Remember user preferences and facts using MemB memory
...
- Python packages: openai, elevenlabs, crewai, membai, pyaudio
"""
...
def get_agent_response(user_input):
    ...
    try:
        ...
        crew = Crew(
            ...
            verbose=True,
            memory=True,
            memory_config={"provider": "memb", "config": {"user_id": USER_ID}},
        )
        result = crew.kickoff()
...
# ------------------ MAIN LOOP ------------------
def run_voice_agent():
    print("🧠 Voice agent (Whisper + MemB + ElevenLabs) is ready! Say something.")
    while True:
