"""
Memory-Powered Movie Recommendation Assistant (Grok 3 + MemB)
This script builds a personalized movie recommender that remembers your preferences
(e.g. dislikes horror, loves romcoms) using MemB as a memory layer and Grok 3 for responses.
...
# Configure MemB with Grok 3 and Qdrant
config = {
