...
import { createMemB, getMemories } from '@memb/vercel-ai-provider';
...
export const useChat = ({ user, membApiKey, openaiApiKey, provider }: UseChatProps): UseChatReturn => {
