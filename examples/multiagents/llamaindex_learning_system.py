"""
Multi-Agent Personal Learning System: MemB + LlamaIndex AgentWorkflow Example
...
class MultiAgentLearningSystem:
    ...
    def __init__(self, student_id: str):
        ...
        self.memory = MemBMemory.from_client(context=self.memory_context)
...
if __name__ == "__main__":
    """Run the example"""
    logger.info("Multi-agent Learning System powered by LlamaIndex and MemB")
