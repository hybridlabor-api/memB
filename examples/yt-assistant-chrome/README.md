# MemB Assistant Chrome Extension

A powerful Chrome extension that combines AI chat with your personal knowledge base through memb. Get instant, personalized answers about video content while leveraging your own knowledge and memories - all without leaving the page.
...
- Memory capabilities powered by MemB
- Dark mode support
...
- **Future memb Integration**: Personalized responses based on your knowledge (coming soon)
