...
from memb_cli.commands.init_cmd import _ping_key
from memb_cli.plugin_sync import _update_claude_settings, _update_shell_rc
...
def test_claude_settings_does_not_create_memb_entry_in_existing_env(tmp_path) -> None:
    import json
...
def test_bootstrap_403_permission_surfaces_ratelimit(monkeypatch, capsys) -> None:
    ...
    from memb_cli.commands.agent_mode_cmd import bootstrap_via_backend
    from memb_cli.config import MemBConfig
    ...
    cfg = MemBConfig()
    cfg.platform.base_url = "https://api.memb.ai"
    import typer
