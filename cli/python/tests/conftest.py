"""Shared fixtures for memb CLI tests."""
...
def isolate_config(tmp_path, monkeypatch):
    ...
    fake_config_dir = tmp_path / ".memb"
    fake_config_file = fake_config_dir / "config.json"
    monkeypatch.setattr("memb_cli.config.CONFIG_DIR", fake_config_dir)
...
def sample_config():
    ...
    config.platform.base_url = "https://api.memb.ai"
    return config
