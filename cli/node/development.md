...
### Option 3: Link globally (makes `memb` available system-wide)
...
> **Warning:** If you also have the Python CLI installed, both register the `memb` command. The last one linked/installed wins. Unlink with `pnpm unlink --global`.
